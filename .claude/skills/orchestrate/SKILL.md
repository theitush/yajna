...
The three lists — what is running, what is planned, what ran — are one file now, written by the commands in §2 and §3 and rendered in two places.
