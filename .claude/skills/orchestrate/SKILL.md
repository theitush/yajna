...
- Nothing running still prints the header and all three stages, with `Running  —`. A stage whose rows are all in the subagent panel is a different thing, and is simply not on the pinned panel.
